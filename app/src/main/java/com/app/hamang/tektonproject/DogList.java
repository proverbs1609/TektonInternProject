...
public class DogList extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                dialog(item.animalName, item.animalImage);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                Object o = listView.getItemAtPosition(i) ;
                DogItem item = (DogItem) o ;
                MainActivity.animalList.remove(i) ;
    ...
    public void dialog(String name, int image){
        mCustomDialog = new MypageMain(getContext(),
                "[ 나의 댕댕이 ]", name, image, saveListener,
                closeListener, menu1Listener, menu2Listener, menu3Listener); // 오른쪽 버튼 이벤트
        mCustomDialog.show();
    }
    public void edit(String name, int image){
        MainActivity.animalList.set(position, new DogItem(name, image, dogSpe, dogSpeNum)) ;
        MainActivity.listviewadapter.notifyDataSetChanged();
    }
    private View.OnClickListener saveListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            final View dialogView = inflater.inflate(R.layout.signup2_layout, null);
            final AlertDialog.Builder buider1 = new AlertDialog.Builder(getContext());
            buider1.setIcon(android.R.drawable.ic_menu_add);
            ...
            buider1.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    dogName = name ;
                    dogGender = gender ;
                    edit(dogName, dogImage) ;
                    setDialog(dogName, dogImage) ;
                }
            });
    ...
    public void setDialog(String setName, int setImage){
        newDialog = new MypageMain(getContext(),
                "[ 나의 댕댕이 ]", setName, setImage, saveListener,
