...
public class ActionMypage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mypage_action_activity);
    ...
    public void onButtonClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.bng_button3:
                actionTitle = "반려인 외출 시 계속 짖거나 운다";
            ...
            case R.id.attack_button4:
                actionTitle = "입에 문것을 뺏을 때 공격성을 보인다";
        ...
        action_button.setTitle(actionTitle);
        action_button.setMessage(actionMessage);
        action_button.show();
    }
    @Override
