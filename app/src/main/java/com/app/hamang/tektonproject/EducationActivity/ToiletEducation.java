...
public class ToiletEducation extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu2Button = (Button) findViewById(R.id.toilet_menu2);
        menu3Button = (Button) findViewById(R.id.toilet_menu3);
        menu4Button = (Button) findViewById(R.id.toilet_menu4);
    ...
    public ToiletEducation(Context context, String title, View.OnClickListener closeListener,
