...
public class NecessityEducation extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu2Button = (Button) findViewById(R.id.necessity_menu2);
    ...
    public NecessityEducation(Context context, String title, View.OnClickListener closeListener,
