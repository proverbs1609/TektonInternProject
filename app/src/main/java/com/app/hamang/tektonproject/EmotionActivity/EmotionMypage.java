...
public class EmotionMypage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mypage_emotion_activity);
    ...
    public void onButtonClick(View view) {
        ...
        emotion_button.setTitle(emotionTitle);
        emotion_button.setMessage(emotionMessage);
        emotion_button.show();
    }
    @Override
