...
public class VideoEducation extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu2Button = (Button) findViewById(R.id.video_menu2);
        menu3Button = (Button) findViewById(R.id.video_menu3);
        menu4Button = (Button) findViewById(R.id.video_menu4);
        menu5Button = (Button) findViewById(R.id.video_menu5);
        menu6Button = (Button) findViewById(R.id.video_menu6);
    ...
    public VideoEducation(Context context, String title, View.OnClickListener closeListener,
